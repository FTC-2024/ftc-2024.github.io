<template>
  <section class="gnt-sec-0 op-brown lighten-2 my-0 py-0">
    <v-container>
      ...
      <v-row>
        <v-col cols="12">
          <h2 class="text-h6 font-weight-bold">Submission & Leadersboard</h2>
        </v-col>
        <v-col cols="12" class="d-none d-md-block">
          <v-btn
            :href="urlCodalab"
...
export default {
  ...
  data: () => ({
    urlGoogleForm:
      'https://docs.google.com/forms/d/e/1FAIpQLSc5HHnSEOGFrOgRtjIjVQ6zrtyBJ8a_FCMhqFXPXUCYa_nwvg/viewform?usp=sf_link',
